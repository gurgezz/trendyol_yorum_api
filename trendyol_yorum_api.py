...
# Trendyol ürün yorumlarını çekmek için fonksiyon
def trendyol_yorumlari_cek(urun_url, yorum_sayisi=50):
    options = Options()
    ...
    # Sayfanın sonuna kadar kaydır, yorumların yüklenmesi için
    for _ in range(10):
    ...
    for yorum in yorumlar[:yorum_sayisi]:
        try:
            ...
            try:
                ...
                style = star_div.get_attribute("style")  # örn: width: 80%
...
def yorumlar_endpoint():
    ...
    yorumlar = trendyol_yorumlari_cek(URUN_URL, yorum_sayisi=50)
    return jsonify(yorumlar)

if __name__ == "__main__":
    # Uygulamayı localhost üzerinde 5000 portunda başlat
